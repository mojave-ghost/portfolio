  ...
  return (
    <section id="about" className="relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <h3 className="mx-6 text-support3 text-lg font-semibold" style={{WebkitTextStroke: '1px black'}}>Welcome to my portfolio!</h3>
        <br></br>
        <p className="text-support3 mx-6 my-4 leading-relaxed" style={{WebkitTextStroke: '1px black'}}>
